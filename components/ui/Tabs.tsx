            ...
            <AriaTabList
                ...
                className={(state) =>
                    cx(
                        ...
                        type === "underline" &&
                        "relative before:content-[''] before:absolute before:inset-x-0 before:bottom-0 before:h-px before:bg-border-secondary",
            ...
            {(state) => (
                <Fragment>
                    ...
                    {badge && (
                        <Badge
                            size={size}
                            variant={getColorStyles(state)[type] === "gray" ? "default" : getColorStyles(state)[type] as "brand" | "error" | "warning" | "success"}
