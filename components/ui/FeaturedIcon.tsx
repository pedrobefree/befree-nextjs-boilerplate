import type { FC, ReactNode, Ref, ComponentType } from "react";
...
const styles = sortCx({
    ...
    outline: {
        base: "before:content-[''] before:absolute before:rounded-full before:border-2 after:content-[''] after:absolute after:rounded-full after:border-2",
        sizes: {
...
export const FeaturedIcon = (props: FeaturedIconProps) => {
    ...
    return (
        ...
        >
            {/* Render the icon if it's a component (function or ForwardRef) */}
            {Icon && (typeof Icon === "function" || typeof Icon === "object") && !isValidElement(Icon) && (
            ...
            {/* Render the icon if it's a valid element */}
